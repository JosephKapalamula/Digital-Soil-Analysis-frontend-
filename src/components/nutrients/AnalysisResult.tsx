      ...
      <div className="p-6">
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <span className="text-3xl font-black">{data.pH.toFixed(1)}</span>
          </div>
        ...
        <div className="bg-slate-900 rounded-xl p-5 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-xs mt-2 leading-relaxed italic">
              "Based on current nutrient profiles, {data.crop} has the highest
              yield potential for this soil type."
            </p>
          </div>
